...
[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/syoh/my-awesome-project/main)
...
git branch -M main
git remote add origin https://github.com/syoh/my-awesome-project.git
